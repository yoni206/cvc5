...
class SatRelevancy
{
  typedef context::CDHashMap<Node, std::shared_ptr<RlvWaitInfo>, NodeHashFunction>
      RlvWaitMap;
 public:
 ...
 private:
   ...
   */
  void setAssertedChild(TNode atom, bool pol, Node parent, context::CDQueue<TNode>& queue);
